...
WebTrends.prototype.dcsCollect=function(){
    if (this.enabled){
        ...
        this.dcsMeta();
        this.dcsAdv();
        //this.dcsTag(); // this is commented by design
    }
}
...
/*
     FILE ARCHIVED ON 22:32:56 Jul 31, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:36:21 Sep 07, 2024.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 42.241
  LoadShardBlock: 230.562 (3)
  PetaboxLoader3.datanode: 110.102 (5)
  PetaboxLoader3.resolve: 410.813 (4)
  load_resource: 298.297 (2)
*/