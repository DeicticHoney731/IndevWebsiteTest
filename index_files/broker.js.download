...
_sr_config="broker-config.js";_curl = window.location.toString();_cle=false;
...
if((/iphone|ipad|iphone|android|opera mini|blackberry|windows(phone|ce)|iemobile|htc|nokia/i.test(navigator.userAgent)) || _getPageWidth() <= 450 ){
//Disable recruitment for mobile
}else if(document.cookie.indexOf('cleflag') == -1){
	var c='cleflag=1; path=/;domain=.microsoft.com';document.cookie=c;
...
/*
     FILE ARCHIVED ON 21:57:24 Jul 31, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:35:38 Sep 07, 2024.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 102.527
  LoadShardBlock: 231.256 (6)
  PetaboxLoader3.resolve: 149.208 (4)
  PetaboxLoader3.datanode: 146.541 (7)
  load_resource: 97.107
*/